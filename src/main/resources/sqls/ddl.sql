...
(
    ...
    interest_rate        INT      NOT NULL COMMENT '이자율',
...
(
    ...
    internal_policy_id               BIGINT NOT NULL COMMENT '내부기준 종류 ID',
    evaluated_value                  INT    NOT NULL COMMENT '평가된 값',
    standard_score                   INT    NOT NULL COMMENT '내부기준 평가점수',
    INDEX idx_customer_id (customer_id),
    INDEX idx_internal_policy_id (internal_policy_id)
